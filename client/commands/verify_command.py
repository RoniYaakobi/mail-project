...
class VerifyCommand(Command):
    def __init__(self, controller, username, password, code, *args, **kwargs):
    ...
    def initialize(self):
        self.connected = self.controller.backend().verify_account(self.username, self.password, self.code)
    ...
    def end(self, interrupted):
        if not interrupted:
            messagebox.showinfo("Verify", f"Verified {self.username}!")
